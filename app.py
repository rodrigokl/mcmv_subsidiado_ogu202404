...
# Exibir obras por construtora sem repetidos
obras_unicas = obra_por_construtora.drop_duplicates(subset=['txt_nome_construtora_entidade', 'txt_cnpj_construtora_entidade'])

# Exibir o DataFrame em uma tabela no Streamlit
st.write("Obras por Construtora/Entidade (sem repetição):")
st.dataframe(obras_unicas)
...
# Ler o arquivo CSV
df = pd.read_csv('mcmv_subsidiado_ogu202404.csv', encoding='ISO-8859-1')
st.title('Banco geral sem repetidos')
